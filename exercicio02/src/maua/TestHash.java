...
import static maua.SList.printLista;
    ...
    public static void main(String[] args) {
        ...
        for(int i=1; i<tabKeys.length; i++){
            ...
            if (tabHash[hashCode] == null )
                tabHash[hashCode] = new SList(tabKeys[i]);
            else {
        ...
        System.out.println(printLista(tabHash[2]));
        System.out.println("\nTabela HASH:");
        System.out.println("--------------------------");
        for(int i=0; i<tabHash.length; i++){
            if (tabHash[i] == null)
                ...
                System.out.println("Slot" + i + " ---> " + printLista(tabHash[i]));
        }
    }
